      ...
      <div className="bg-emerald-50 border border-emerald-200 text-emerald-800 rounded-[3rem] p-16 text-center space-y-8 max-w-2xl mx-auto shadow-2xl animate-in zoom-in-95 duration-500">
        ...
        <div className="space-y-4">
          ...
          <p className="text-emerald-700/80 text-lg leading-relaxed font-medium">
            Your {selectedMock?.title} mock test has been successfully scheduled for {selectedDate} at {selectedTime}. Check your email for access credentials.
          </p>
        </div>
        <button 
      ...
      <div className="lg:col-span-7 space-y-16">
        ...
        <section>
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-2xl font-headline font-black text-secondary tracking-tight">Select Examination</h2>
          </div>
            ...
            {MOCK_TESTS.map((test) => (
              ...
              >
                <div className={cn(
                  ...
                  selectedId === test.id ? "text-primary" : "text-secondary/40"
                )}>
                  {test.badge}
                </div>
                <h3 className="text-2xl font-headline font-black text-secondary mb-2 group-hover:text-primary transition-colors">{test.title}</h3>
                ...
                >
                  {selectedId === test.id && <span className="material-symbols-outlined text-sm">check_circle</span>}
        ...
        <section>
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-2xl font-headline font-black text-secondary tracking-tight">Secure Payment</h2>
          </div>
          ...
          <div className="bg-surface-container p-8 rounded-[3rem] space-y-8">
            ...
            <div className="p-6 bg-white/50 rounded-2xl flex items-center gap-4">
              ...
              <p className="text-xs text-on-surface-variant font-medium leading-snug">
                Your credentials are encrypted via 256-bit AES and processed through PCI-compliant gateways.
              </p>
            </div>
      ...
      <div className="lg:col-span-5 sticky top-28 space-y-8">
        ...
        <section className="bg-surface-container-lowest p-10 rounded-[3rem] shadow-sm border border-outline/5">
          <div className="flex items-center gap-4 mb-10">
            ...
            <h2 className="text-2xl font-headline font-black text-secondary tracking-tight">Select Date & Time</h2>
          </div>
          ...
          <div className="space-y-12">
            ...
            <div className="space-y-6">
              <h3 className="font-headline font-black text-xs text-secondary/40 uppercase tracking-widest">Available Time Slots</h3>
        ...
        <section className="bg-secondary p-10 rounded-[3rem] text-white shadow-2xl shadow-secondary/20 relative overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-10">
            <h3 className="text-2xl font-headline font-black tracking-tight">Order Summary</h3>
            <span className="text-[10px] font-black uppercase tracking-widest bg-white/10 px-3 py-1 rounded-full">Secure</span>
          </div>
          ...
          <div className="space-y-6 mb-12 relative z-10">
            <div className="flex flex-col gap-1 pb-6 border-b border-white/5">
              ...
              <span className="text-xl font-bold tracking-tight">{selectedMock?.title} Mock Exam</span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-8 pb-6 border-b border-white/5">
              ...
              <div className="flex flex-col gap-1 text-right">
                <span className="text-[10px] font-black text-white/30 uppercase tracking-[0.2em]">Time Slot</span>
                <span className="text-sm font-bold uppercase">{selectedTime}</span>
              </div>
            </div>
            
            <div className="flex justify-between items-end pt-4">
              <span className="text-sm font-black text-white/40 uppercase tracking-widest">Total Investment</span>
          ...
          <div className="flex items-center gap-3 text-[10px] font-black text-white/20 uppercase tracking-[0.2em] justify-center mt-10">
