...
const A1_SCHEDULE: Record<number, string[]> = {
  1: ["1:15 PM"], // Monday
};
...
export function DateStep({
  ...
  const availableSlots = value ? A1_SCHEDULE[value.getDay()] || [] : [];
        ...
        <div className="mt-8 grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="p-4 rounded-xl bg-amber-50 border border-amber-100 text-amber-800 text-sm font-medium leading-relaxed">
              Note: The available time slots are based on our official PTE Home A1 weekly schedule.
            </div>
          </div>
        </div>
