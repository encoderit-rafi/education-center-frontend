...
export const PteHomeA1Schema = z.object({
    ...
    // Previous Test History (PTE Home A1 specific labels)
...
export const RefinedPteHomeA1Schema = PteHomeA1Schema.refine((data) => {
...
export type TPteHomeA1FormSchema = z.infer<typeof RefinedPteHomeA1Schema>;
