  ...
  return (
    ...
    >
      ...
      <div className="pt-8 border-t border-slate-100 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Field data-invalid={!!errors.emailUsername} className="lg:col-span-2">
      ...
      <div className="pt-8 border-t border-slate-100 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <Field data-invalid={!!errors.passportCopy} className="md:col-span-2">
            <FieldLabel required>Attach Passport / ID Copy</FieldLabel>
            <FieldContent>
              <div className="flex flex-col gap-2">
                {!formData.passportCopy ? (
                  <Input
                    type="file"
                    className="h-auto py-2 px-3 border-2 border-dashed border-slate-200 hover:border-primary/50 cursor-pointer file:mr-4 file:py-1 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-primary/10 file:text-primary"
                    onChange={(e) => {
