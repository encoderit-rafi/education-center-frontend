...
export default function FormSELTC2Registration({ examId: initialExamId }: FormProps = {}) {
  ...
  const activeExam = initialExamId
    ...
    : examsList.find((e: any) => e.slug === "ukvi-speaking-listening-reading-and-writing-at-level-c2");
  ...
  const examName = activeExam?.name || Object.values(EXAM_IDS_DATA).find(e => e.id === initialId)?.name || "SELT C2";
