...
export default function FormSELTA2Registration({ examId: initialExamId }: FormProps = {}) {
  ...
  const activeExam = initialExamId
    ...
    : examsList.find((e: any) => e.slug === "ukvi-speaking-and-listening-at-level-a2");
  ...
  const examName = activeExam?.name || Object.values(EXAM_IDS_DATA).find(e => e.id === initialId)?.name || "SELT A2";
