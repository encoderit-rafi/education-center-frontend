...
export default function FormSELTB1Registration({ examId: initialExamId }: FormProps = {}) {
  ...
  const activeExam = initialExamId
    ...
    : examsList.find((e: any) => e.slug === "ukvi-speaking-and-listening-at-level-b1");
  ...
  const examName = activeExam?.name || Object.values(EXAM_IDS_DATA).find(e => e.id === initialId)?.name || "SELT B1";
