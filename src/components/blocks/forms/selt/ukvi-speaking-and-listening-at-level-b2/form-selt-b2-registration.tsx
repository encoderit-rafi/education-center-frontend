...
export default function FormSELTB2Registration({
  ...
  const titleObj = useRegistrationTitle(activeExam?.slug || "ukvi-speaking-listening-reading-and-writing-at-level-b2", activeExam);
      ...
      try {
        ...
        const compiledPayload = compileBookingPayload({
          ...
          allFormData: {
            ...
            level_name: activeExam?.name || "SELT B2",
