...
import { IeltsUkviGeneralSchema, type TIeltsUkviGeneralSchema } from "./_type";
...
export default function FormIELTSUKVIGeneralRegistration() {
  const [step, setStep] = useState(0);

  const form = useForm<TIeltsUkviGeneralSchema>({
    resolver: zodResolver(IeltsUkviGeneralSchema),
    defaultValues: {
  ...
  const onSubmit = async (data: TIeltsUkviGeneralSchema) => {
