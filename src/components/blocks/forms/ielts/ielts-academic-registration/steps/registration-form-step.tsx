      ...
      <div className="bg-white rounded-2xl border border-slate-100 p-6 md:p-8 shadow-sm space-y-8">
        ...
        <div className="pt-8 border-t border-slate-100 space-y-6">
          <div className="flex items-center gap-2 text-slate-400 mb-4">
            ...
            <h3 className="text-lg font-bold tracking-tight text-slate-800">Identity & Contact</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Field data-invalid={!!errors.residenceCountry}>
              ...
              <FieldContent>
                <CountryDropdown
                  ...
                  onChange={(country) => setValue("residenceCountry", country.name)}
                />
            ...
            <Field data-invalid={!!errors.idExpiryDate}>
              <FieldLabel required>
                {formData.idType === "emirates_id" ? "ID expiry date" : "Passport expiry date"}
              </FieldLabel>
              <FieldContent>
                <DatePicker
        ...
        <div className="pt-8 border-t border-slate-100 space-y-6">
          <div className="flex items-center gap-2 text-slate-400 mb-4">
            ...
            <h3 className="text-lg font-bold tracking-tight text-slate-800">Additional Information</h3>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Field className="md:col-span-2 lg:col-span-3" data-invalid={!!errors.takenBefore}>
              <FieldLabel required>Have you taken the CD-IELTS Test before?</FieldLabel>
            ...
            {formData.takenBefore === "Yes" && (
              <>
                <Field className="md:col-span-2 lg:col-span-3" data-invalid={!!errors.lessThanTwoYears}>
                ...
                <Field className="md:col-span-2 lg:col-span-3" data-invalid={!!errors.existingAccount}>
                  <FieldLabel required>Do you have an existing IELTS account?</FieldLabel>
                  <FieldContent className="mt-2">
                    <RadioGroup
                    ...
                    >
                      {["Yes", "No", "I forgot my IELTS account details"].map((opt) => (
                        <Label
                          key={opt}
                          htmlFor={`acc-${opt}`}
            ...
            <Field className="md:col-span-2 lg:col-span-3" data-invalid={!!errors.specialRequirements}>
              <FieldLabel required>Do you have any special requirements due to ill health/medical conditions?</FieldLabel>
              <FieldContent className="mt-2">
                <RadioGroup
            ...
            <Field data-invalid={!!errors.yearsStudyingEnglish}>
              <FieldLabel required>How many years have you been studying English?</FieldLabel>
              <FieldContent>
                <SearchableDropdown
                  options={[
            ...
            <Field className="md:col-span-2" data-invalid={!!errors.educationLevel}>
            ...
            <Field data-invalid={!!errors.reasonForTakingTest}>
              ...
              <FieldContent>
                <SearchableDropdown
                  options={[
                    { label: "Higher education extended course", value: "higher_edu_long" },
            ...
            <Field data-invalid={!!errors.destinationCountry}>
              ...
              <FieldContent>
                <CountryDropdown
                  ...
                  onChange={(country) => setValue("destinationCountry", country.name)}
                />
        ...
        <div className="pt-8 border-t border-slate-100 space-y-6">
          <div className="flex items-center gap-2 text-slate-400 mb-4">
            ...
            <h3 className="text-lg font-bold tracking-tight text-slate-800">Add-ons Services</h3>
          </div>
        ...
        <div className="pt-8 border-t border-slate-100 space-y-6">
          <Field data-invalid={!!errors.marketingPreference}>
            ...
            <FieldContent className="mt-4">
              ...
              >
                {[
                  { id: "all", label: "I am happy to receive updates about products, services and events organised by British Council." },
                  { id: "some", label: "I am happy to receive information from British Council and selected third parties." },
        ...
        <div className="mt-12 flex justify-between items-center pt-6 border-t border-slate-100">
          ...
          >
            <Save className="size-5" /> Save and Proceed
          </Button>
        </div>
      </div>
    </form>
