...
export default function FormIELTSAcademicRegistration() {
  ...
  const getFieldsForStep = (currentStep: number) => {
    switch (currentStep) {
      ...
      case 5:
        return ["confirmationRecipient", "termsAgreed"];
      default:
        return [];
    }
  };
    ...
    <div className="section base-py">
      ...
      <div className="max-w-4xl mx-auto base-px ">
        <div className="flex flex-col mb-8">
          <span className="section-label">Step {step} of 5</span>
                ...
                <div className="space-y-8">
                  ...
                  <div className="space-y-4">
                    <p className="text-xs text-gray-400 font-medium leading-relaxed">
                      The British Council would like to use the information you
                      provide to send details of activities, services and events
                      (including social events) which we think are of interest.
                    </p>
                    <button
                      type="button"
                          ...
                          <FormControl>
                            ...
                            >
                              {[
                                ...
                                <div
                                  key={opt.id}
                                  className="flex items-center space-x-4 p-4 rounded-xl border border-slate-100 hover:border-slate-200 transition-all cursor-pointer group bg-slate-50/30"
                                >
                                  <RadioGroupItem
                                    value={opt.id}
                                    id={opt.id}
                          ...
                          <FormControl>
                            ...
                            >
                              {[
                                ...
                                <div
                                  key={opt.id}
                                  className="flex items-center space-x-4 p-4 rounded-xl border border-slate-100 hover:border-slate-200 transition-all cursor-pointer group bg-white shadow-sm"
                                >
                                  <RadioGroupItem
                                    value={opt.value}
                                    id={opt.id}
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white rounded-2xl border border-slate-100 shadow-xl shadow-slate-200/50 overflow-hidden">
                    ...
                    <div className="bg-slate-50 p-6 flex flex-col md:flex-row justify-between items-center gap-4">
                      <button
                        type="button"
                        className="text-[#A11D1D] text-xs font-black uppercase tracking-widest hover:underline underline-offset-8"
                      >
                        Pay offline
                      </button>
                      <p className="text-gray-400 text-[10px] font-medium uppercase tracking-widest">
                        Payment options will be shown on next page
                      </p>
                    </div>
                  </div>
                </div>
