...
export const IeltsAcademicSchema = z
  .object({
    ...
    sex: z
      ...
      .or(z.literal("")),
    // Note: sex required check handled in superRefine
    ...
    // Note: idType required check handled in superRefine
    ...
    // Note: additional required field checks handled in superRefine
