...
import { IeltsLifeSkillsA1Schema, type TIeltsLifeSkillsA1Schema } from "./_type";
...
export default function FormIELTSLifeSkillsA1Registration() {
  const [step, setStep] = useState(0);

  const form = useForm<TIeltsLifeSkillsA1Schema>({
    resolver: zodResolver(IeltsLifeSkillsA1Schema),
    defaultValues: {
      testModule: "ielts-life-skills-a1",
      bookingFor: "",
      givenNames: "",
      middleName: "",
      surnames: "",
  ...
  const onSubmit = async (data: TIeltsLifeSkillsA1Schema) => {
