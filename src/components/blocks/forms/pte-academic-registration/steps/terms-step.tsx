...
const NOTICES: string[] = [
  "The PTE Academic Test registration service is offered by The Exam Preparation & Testing House LLC for the convenience of the test-takers. We hold no control or responsibility regarding any issues related to test results, scoring or other. We have no involvement in the test itself.",
  "The registration service is entirely voluntary and candidates can book their test at the center directly through Pearson without paying for the additional fee. Any candidate who wishes to use TEPTH registration service offered by our staff will be charged an additional AED 100 (service charge) on top of the PTE Academic exam fee.",
