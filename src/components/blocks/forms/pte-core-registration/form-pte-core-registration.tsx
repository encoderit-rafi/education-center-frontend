...
export default function FormPTECoreRegistration() {
  ...
  const getFieldsForStep = (currentStep: number): (keyof TPteCoreFormSchema)[] => {
    switch (currentStep) {
            ...
            {step === 2 && (
              <div className="space-y-12 animate-in fade-in slide-in-from-right-8 duration-500">
                <div className="bg-orange-50/50 border border-orange-100 rounded-2xl p-6 md:p-8 space-y-4">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed font-medium">PTE Core is used for Canadian permanent residency. Please ensure details match your passport.</p>
                </div>
                  ...
                  <div className="grid grid-cols-1 gap-8">
                    <FormField control={control} name="givenNames" render={({ field }) => (
                      <FormItem className="space-y-2">
                        ...
                        <FormControl><Input placeholder="As per passport" className="h-12" {...field} /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                          ...
                          <FormControl>
                            <RadioGroup className="flex gap-8 h-12 items-center" onValueChange={field.onChange} value={field.value}>
                              {["Male", "Female", "Other"].map(s => (
                                <div key={s} className="flex items-center space-x-2 cursor-pointer">
                                  <RadioGroupItem value={s.toLowerCase()} id={`g-core-${s}`} className="border-[#A11D1D]" />
                                  <Label htmlFor={`g-core-${s}`} className="text-sm font-bold capitalize cursor-pointer">{s}</Label>
                                </div>
                              ))}
                            </RadioGroup>
                          </FormControl>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <FormField control={control} name="address" render={({ field }) => (
                      <FormItem className="space-y-2">
                        ...
                        <FormControl><Input placeholder="Building, Street, Area" className="h-12" {...field} /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                    <FormField control={control} name="city" render={({ field }) => (
                      <FormItem className="space-y-2">
                        ...
                        <FormControl><Input placeholder="Current city" className="h-12" {...field} /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                  </div>
                ...
                <div className="space-y-8 pt-8 border-t border-slate-100">
                  ...
                  <FormField control={control} name="readyToBook" render={({ field }) => (
                    <FormItem className="space-y-4">
                      <FormLabel className="text-sm font-bold text-gray-700 leading-relaxed">Are you ready to book your PTE Core test?*</FormLabel>
                      <FormControl>
              ...
              <div className="space-y-12 animate-in fade-in slide-in-from-right-8 duration-500">
                <div className="space-y-8">
                  ...
                  <FormField control={control} name="reasonForTaking" render={({ field }) => (
                    <FormItem className="space-y-6">
                      <FormLabel className="text-sm font-bold text-gray-700">Why are you taking PTE Core?*</FormLabel>
                      <FormControl>
                        <RadioGroup onValueChange={field.onChange} value={field.value} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {["Economic Class Residency", "Citizenship", "Other"].map(r => (
                ...
                <div className="space-y-8 pt-8 border-t border-slate-100">
                  ...
                  <FormField control={control} name="takenBefore" render={({ field }) => (
                    <FormItem className="space-y-6">
                      <FormLabel className="text-sm font-bold text-gray-700">Have you taken PTE Core before?*</FormLabel>
                      <FormControl>
                        <RadioGroup onValueChange={field.onChange} value={field.value} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {[{ label: "Yes", value: "yes" }, { label: "No", value: "no" }].map(opt => (
                ...
                <div className="space-y-8 pt-8 border-t border-slate-100">
                  ...
                  <div className="bg-slate-50 p-8 rounded-2xl border border-slate-100 space-y-6">
                    <p className="text-sm font-medium text-gray-600 leading-relaxed">PTE Core scores can be used for migration to Australia and New Zealand. Would you like Pearson to send your scores to these governments?</p>
                  ...
                  <div className="space-y-6">
                    ...
                    <FormField control={control} name="bookingTermsAgreed" render={({ field }) => (
                      <FormItem className="flex items-start space-x-4 p-6 rounded-2xl bg-[#A11D1D]/5 border border-[#A11D1D]/10">
                        <FormControl><Checkbox checked={field.value} onCheckedChange={field.onChange} className="data-[state=checked]:bg-[#A11D1D] mt-1" /></FormControl>
                        <div className="space-y-1">
                          <Label className="text-sm font-bold text-gray-900 cursor-pointer">I have read and agree to the PTE Core Test Taker Handbook and Booking Terms and Conditions.*</Label>
                        </div>
                      </FormItem>
                    )} />
