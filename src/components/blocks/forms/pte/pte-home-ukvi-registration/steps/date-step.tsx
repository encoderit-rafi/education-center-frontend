...
const UKVI_SCHEDULE: Record<number, string[]> = {
  0: ["6:15 PM"], // Sunday
...
export function DateStep({
  ...
  const getSessionLabel = (slot: string) => {
    if (slot.includes("10:00 AM")) return "Morning Session";
    if (slot.includes("12:45 PM") || slot.includes("3:30 PM")) return "Afternoon Session";
    if (slot.includes("6:15 PM")) return "Evening Session";
    return "Test Session";
  };
      ...
      <div className="bg-white rounded-2xl border border-slate-100 p-6 md:p-8 shadow-sm">
        ...
        <div className="mt-8 grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="p-4 rounded-xl bg-amber-50 border border-amber-100 text-amber-800 text-sm font-medium leading-relaxed">
              Note: The available time slots are based on our official PTE Academic UKVI weekly schedule.
            </div>
          </div>
        </div>
