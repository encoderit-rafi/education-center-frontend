...
// Schema
import { RefinedPteHomeB1Schema, type TPteHomeB1FormSchema } from "./_type";
...
export default function FormPTEHomeB1Registration() {
  ...
  const handleFormSubmit: SubmitHandler<TPteHomeB1FormSchema> = (data) => {
    if (currentStep < 3) {
      nextStep();
    } else {
      toast.success("PTE Home B1 Registration Submitted Successfully!");
