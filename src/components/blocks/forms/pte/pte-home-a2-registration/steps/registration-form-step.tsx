...
interface RegistrationFormStepProps {
  ...
  onSubmit: (data: TPteHomeA2Schema) => void;
    ...
    >
      ...
      <div className="pt-8 border-t border-slate-100 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-8">
          ...
          >
            <FieldLabel required>Why are you taking PTE Home A2?</FieldLabel>
            <FieldContent>
              <SearchableDropdown
                options={[
          ...
          {formData.reasonForTaking === "study" && (
            ...
            >
              <FieldLabel required>
                If you are taking PTE Home A2 for study, which level are you applying for?
              </FieldLabel>
              <FieldContent>
                <SearchableDropdown
                  options={[
          ...
          <Field data-invalid={!!errors.referralSource}>
            <FieldLabel required>How did you hear about PTE Home A2?</FieldLabel>
            <FieldContent>
              <SearchableDropdown
                options={[
