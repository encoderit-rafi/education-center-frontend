...
const NOTICES: (React.ReactNode | string)[] = [
  <span key="1">
    ...
    <strong className="font-semibold">PTE Academic</strong> test registration strictly as an optional convenience for
  ...
  <span key="4">
    Registration for the <strong className="font-semibold">PTE Academic</strong> officially closes{" "}
  ...
  <span key="6">
    In the UAE, the current fee for the <strong className="font-semibold">PTE Academic</strong> exam is{" "}
    ...
    , which is applied in addition to the standard <strong className="font-semibold">PTE Academic</strong> exam fee.
  </span>,
  ...
  <span key="8">
    ...
    with your <strong className="font-semibold">PTE Academic</strong> Registration.
  </span>,
  <span key="9">
    Candidates must be at least 16 years of age to be eligible to sit for the{" "}
    <strong className="font-semibold">PTE Academic</strong> exam.
  </span>,
