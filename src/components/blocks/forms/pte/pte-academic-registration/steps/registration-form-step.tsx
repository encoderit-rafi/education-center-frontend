      ...
      <div className="pt-8 border-t border-slate-100 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8">
            ...
            <FieldContent>
              <SearchableDropdown
                options={[
                  ...
                  {
                    label: tPte("reasonSkilledMigration"),
                    value: "skilled_migration",
                  },
                  {
                    label: tPte("reasonSpouseFamilyVisa"),
                    value: "family_visa",
                  },
                  {
                    label: tPte("reasonWorkingHoliday"),
            ...
            <FieldContent>
              <SearchableDropdown
                options={[
                  ...
                  {
                    label: tPte("referralBoardOfNursing"),
                    value: "board_of_nursing",
                  },
                  {
          ...
          {[
            ...
            "nz_temp_work",
            "skilled_migration",
          ].includes(formData.reasonForTaking) && (
            <Field
