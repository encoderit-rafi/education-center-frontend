      ...
      <div className="pt-8 border-t border-slate-100 space-y-6">
        ...
        <div>
          <Field data-invalid={!!errors.planningCountry}>
            <FieldLabel required>{tPte("planningCountryQuestion")}</FieldLabel>
            <FieldContent>
              <CountryDropdown
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8">
          ...
          >
            ...
            <FieldContent>
              <SearchableDropdown
                options={[
                  { label: tPte("reasonStudy"), value: "study" },
                  { label: tPte("reasonNursing"), value: "nursing" },
                  { label: tPte("reasonAuMates"), value: "au_mates" },
                  { label: tPte("reasonAu485"), value: "au_485" },
                  { label: tPte("reasonAuTempWork"), value: "au_temp_work" },
                  { label: tPte("reasonNzTempWork"), value: "nz_temp_work" },
                  { label: tPte("reasonSkilledMigration"), value: "skilled_migration" },
                  { label: tPte("reasonSpouseFamilyVisa"), value: "family_visa" },
                  { label: tPte("reasonWorkingHoliday"), value: "working_holiday" },
        ...
        <div className="space-y-3 md:col-span-2 animate-in fade-in slide-in-from-top-2">
          <Field data-invalid={!!errors.takenBefore}>
            <FieldLabel required>
              {tPte("haveYouTakenBefore", { module: "Academic" })}
            </FieldLabel>
