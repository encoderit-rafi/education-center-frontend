...
const PTE_SCHEDULE: Record<number, string[]> = {
  0: ["6:15 PM"], // Sunday
  1: ["1:00 PM"], // Monday
  2: ["3:30 PM"], // Tuesday
  3: ["1:00 PM"], // Wednesday
  4: ["3:30 PM", "6:15 PM"], // Thursday
  6: ["3:30 PM"], // Saturday
  5: [], // Friday (Closed)
};
              ...
              <Calendar
                ...
                modifiers={{
                  available: (date) => {
                    ...
                    return PTE_SCHEDULE[day] && PTE_SCHEDULE[day].length > 0;
                  },
                }}
                modifiersClassNames={{
                  available:
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <p className="text-sm font-medium" dir="ltr">{slot}</p>
                          </div>
                        </Label>
                      );
                    })}
