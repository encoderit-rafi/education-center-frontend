            ...
            <FieldContent>
              <SearchableDropdown
                options={[
                  ...
                  {
                    label: tPte("reasonSkilledWorkerVisa"),
                    value: "skilled_worker_visa",
                  },
                  {
                    label: tPte("reasonStartupInnovatorVisa"),
                    value: "startup_innovator_visa",
                  },
                  {
                    label: tPte("reasonDomesticWorker"),
                    value: "domestic_worker",
                  },
                  {
                    label: tPte("reasonMinisterReligion"),
                    value: "minister_religion_visa",
                  },
                ...
                onChange={(val) => {
                  ...
                  if (
                    ![
                      "sportsperson_visa",
                      "skilled_worker_visa",
                      "startup_innovator_visa",
                      "domestic_worker",
                      "minister_religion_visa",
                    ].includes(val)
                  ) {
