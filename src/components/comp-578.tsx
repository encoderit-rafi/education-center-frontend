    ...
    <header className="border-b px-4 md:px-6">
      <div className="flex h-16 items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          {/* Mobile menu trigger */}
          <Popover>
            <PopoverTrigger render={<Button className="group size-8 md:hidden" size="icon" variant="ghost" />}><svg
        ...
        {/* Right side */}
        <div className="flex items-center gap-2">
          <Button className="text-sm" size="sm" variant="ghost" render={<a href="#" />} nativeButton={false}>Sign In</Button>
          <Button className="text-sm" size="sm" render={<a href="#" />} nativeButton={false}>Get Started</Button>
        </div>
      </div>
    </header>
  );
