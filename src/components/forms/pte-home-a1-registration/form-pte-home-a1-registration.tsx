...
export default function FormPTEHomeA1Registration() {
    ...
    const EXAM_FEE = 1150; // PTE Home A1 fee is typically lower
    const SERVICE_FEE = 5;
    const VAT_RATE = 0.05;
    ...
    const onSubmit: SubmitHandler<TPteHomeA1FormSchema> = (data) => {
        console.log("PTE Home A1 Form Data:", data);
    };
        ...
        <div className="bg-[#fcfcfc] font-body text-slate-900 min-h-screen pb-20 selection:bg-red-50">
            ...
            <section className="relative h-[450px] flex items-center justify-center overflow-hidden bg-[#111827]">
                <div className="absolute inset-0 z-0">
                    <img className="w-full h-full object-cover opacity-30 grayscale scale-105" alt="PTE Home A1" src="/images/about-us/infrastructure-center.png" />
                ...
                <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
                    ...
                    <h1 className="text-white text-5xl md:text-8xl font-black tracking-tighter mb-6 font-headline uppercase leading-[0.9]">
                        PTE Home <span className="text-[#A11D1D]">A1</span>
                    </h1>
                    <p className="text-slate-300 text-lg md:text-xl font-medium max-w-2xl mx-auto leading-relaxed">
                        Start your journey to UK settlement or family visa with the trusted PTE Home A1 English test registration.
                    </p>
                </div>
            </section>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                            <div className="space-y-10">
                                                ...
                                                <FormField control={control} name="reasonForTaking" render={({ field }) => (
                                                    <FormItem className="space-y-3">
                                                        <FormLabel className="text-sm font-bold text-slate-700">*Why are you taking PTE Home A1?</FormLabel>
                                                        <FormControl><SearchableDropdown options={[
                                                ...
                                                <div className="p-8 rounded-[2rem] bg-slate-50 border border-slate-100 space-y-8">
                                                    ...
                                                    <FormField control={control} name="takenBefore" render={({ field }) => (
                                                        <FormItem className="space-y-4">
                                                            <FormLabel className="text-sm font-black text-slate-900 uppercase tracking-tighter">*Have you taken the PTE Home A1 Test before?</FormLabel>
                                                            <FormControl>
