...
// --- Schema Definition ---
const toeflFormSchema = z.object({
...
const refinedToeflSchema = toeflFormSchema.refine((data) => data.email === data.confirmEmail, {
...
interface IToeflForm {
    ...
    existingETSAccount?: string;
    selectedOneToOne: boolean;
    selectedWorkshop: boolean;
    selectedExpressDelivery: boolean;
...
export default function FormTOEFLIBTRegistration() {
    ...
    const onSubmit: SubmitHandler<IToeflForm> = (data) => {
