            ...
            <section className="relative h-[450px] flex items-center overflow-hidden bg-[#141b2b]">
                ...
                <div className="relative z-10 max-w-screen-2xl mx-auto px-6 sm:px-12 w-full lg:px-24">
                    <div className="max-w-2xl">
                        <span className="text-[#ffb4ac] font-bold tracking-[0.2em] uppercase text-xs mb-4 block">Academic Calendar</span>
                        <h1 className="text-white text-5xl md:text-7xl font-extrabold tracking-tight font-headline mb-6 leading-tight">
                            Holiday Schedule & <br /><span className="text-[#ffb4ac]">Center Closures</span>
                        </h1>
                        <p className="text-slate-300 text-lg leading-relaxed max-w-xl">
                            Stay informed about upcoming public holidays and scheduled center maintenance. Plan your examination journey with clarity and precision across all our regional venues.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 px-6 sm:px-12 lg:px-24 max-w-screen-2xl mx-auto">
                <div className="flex flex-col lg:flex-row gap-16">
                    <div className="lg:w-2/5">
                        <h2 className="text-3xl font-extrabold text-[#261817] mb-6 font-headline tracking-tight">Upcoming Closures</h2>
                        <p className="text-[#59413e] mb-10 leading-relaxed text-lg font-medium opacity-80">
                            Select a highlighted date on the calendar to view specific closure details for our regional hubs and administrative centers.
                        </p>
                        ...
                        <div className="space-y-6">
                            <div className="bg-[#fce2df] p-8 rounded-2xl flex gap-6 items-center border-l-[6px] border-[#760009] shadow-sm transform transition-transform hover:scale-[1.02]">
                                <div className="bg-[#760009] text-white w-14 h-14 rounded-xl flex flex-col items-center justify-center flex-shrink-0 shadow-lg">
                                    <span className="text-[10px] font-black uppercase tracking-tighter">Dec</span>
                                    <span className="text-xl font-black leading-none">02</span>
                                </div>
                                <div>
                                    <h4 className="font-extrabold text-[#261817] text-lg uppercase tracking-tight">National Day</h4>
                                    <p className="text-sm text-[#59413e] font-medium opacity-80 mt-1 uppercase tracking-tight">All centers closed. Online support active.</p>
                                </div>
                            </div>
                            ...
                            <div className="bg-[#ffe9e6] p-8 rounded-2xl flex gap-6 items-center border-l-[6px] border-[#575e70] shadow-sm transform transition-transform hover:scale-[1.02]">
                                ...
                                <div>
                                    <h4 className="font-extrabold text-[#261817] text-lg uppercase tracking-tight">Winter Break</h4>
                                    <p className="text-sm text-[#59413e] font-medium opacity-80 mt-1 uppercase tracking-tight">Maintenance window at Sharjah Hub.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:w-3/5">
                        <div className="bg-white p-10 rounded-3xl shadow-2xl border border-[#e1bfbb]/30 overflow-hidden relative">
                            ...
                            <div className="flex justify-between items-center mb-10 relative z-10">
                                <h3 className="text-2xl font-black text-[#261817] tracking-tight uppercase">December 2024</h3>
                            ...
                            <div className="grid grid-cols-7 gap-3 text-center mb-6 relative z-10">
                                {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map(day => (
                                    <div key={day} className="text-[10px] font-black text-[#8d706d] uppercase tracking-[0.2em] py-2">{day}</div>
                                ))}
                            </div>

                            <div className="grid grid-cols-7 gap-3 relative z-10">
                                {[30, 31].map(d => (
                                    <div key={d} className="h-28 p-3 text-slate-300 font-bold border border-transparent flex items-start justify-end">{d}</div>
                                ))}
                                {[...Array(28)].map((_, i) => {
                                    const day = i + 1;
                                    ...
                                    return (
                                        <div
                                            key={day}
                                            className={`h-28 p-3 rounded-2xl flex flex-col justify-between transition-all border ${isHoliday
                                        ...
                                        >
                                            <span className={`text-lg font-black ${isHoliday ? 'text-white' : 'text-[#261817]'}`}>{day}</span>
                                            {isHoliday && (
                                                <span className="text-[8px] font-black uppercase tracking-[0.1em] leading-tight">National <br /> Day</span>
                                            )}
                                            {isClosed && (
                                                <span className="text-[9px] font-black uppercase tracking-[0.1em] text-[#760009]">Closed</span>
                                            )}
                                        </div>
                                    );
                                })}
            ...
            <section className="py-32 bg-[#fff0ef]">
                <div className="max-w-screen-2xl mx-auto px-6 sm:px-12 lg:px-24">
                    <div className="text-center mb-20">
                        <span className="text-[#760009] font-black uppercase tracking-[0.3em] text-[10px] mb-4 block">Official Calendar</span>
                        <h2 className="text-5xl font-black text-[#261817] mb-6 font-headline tracking-tight uppercase leading-none">Academic Year 2024-2025</h2>
                        ...
                        <p className="text-[#59413e] max-w-3xl mx-auto text-xl font-medium leading-relaxed opacity-80">
                            Detailed breakdown of institutional holidays and their specific impact on academic deliverables and examination sessions.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        ...
                        {[
                            ...
                            <div key={idx} className="bg-white p-12 rounded-[2.5rem] flex flex-col md:flex-row gap-8 items-start hover:shadow-[0_20px_60px_-15px_rgba(118,0,9,0.15)] transition-all duration-500 group border border-[#e1bfbb]/20">
                                ...
                                <div className="flex-1">
                                    <div className="flex justify-between items-start mb-4">
                                        <h3 className="text-2xl font-black text-[#261817] tracking-tight uppercase">{holiday.title}</h3>
