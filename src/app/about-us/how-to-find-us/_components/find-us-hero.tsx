    ...
    <section className="relative w-full h-[60vh] min-h-[500px] flex items-center overflow-hidden">
      ...
      <div className="container relative z-10 px-6 mx-auto sm:px-12 lg:px-24 text-center md:text-left">
        <div className="max-w-4xl space-y-6">
          <Badge 
            variant="default" 
            className="bg-[#A11D1D] hover:bg-[#8A1818] text-white border-none py-1.5 px-4 text-[10px] font-bold tracking-widest uppercase rounded-sm flex items-center gap-2 w-fit mx-auto md:mx-0"
          >
