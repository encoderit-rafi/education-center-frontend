                ...
                <div className="bg-primary/5 border border-primary/10 rounded-md p-6 max-w-2xl">
                  ...
                  <div className="space-y-3">
                    <p className="text-xs leading-relaxed text-slate-600">
                      ...
                      listening to a lecture or writing an essay based on
                      academic readings.
                    </p>
                ...
                <div className="bg-primary/5 border  border-primary/10 rounded-md p-6 max-w-2xl">
                  ...
                  <div className="space-y-3">
                    <p className="text-xs leading-relaxed text-slate-600">
                      ...
                      test used primarily for permanent residence applications
                      in Canada and Australia. It assesses your ability to use
                      English in everyday, real-world situations through four
                      key modules: Listening, Reading, Writing, and Speaking.
                    </p>
                    <div className="bg-white/50 rounded-md p-3 border border-primary/10">
                      <p className="text-[10px] font-bold text-secondary">
                        Important Notice:
