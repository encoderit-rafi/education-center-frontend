...
export const ieltsWorkshop = {
  ...
  description:
    "Our intensive workshops at TEPTH – The Exam Preparation & Testing House help you quickly understand the exam format, master key strategies, and improve your performance in IELTS — all in focused sessions designed for busy candidates.",
...
export default function ExamWorkshopsIELTS() {
  return (
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center gap-6 px-4">
                <div className="flex items-center gap-2 text-sm font-bold text-slate-500">
                  ...
                  {ieltsWorkshop.logistics.location}
                </div>
                <div className="flex items-center gap-2 text-sm font-bold text-slate-500">
                  <Calendar className="size-4 text-primary" />
                  {ieltsWorkshop.logistics.scheduling} Schedule
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
          <div className="mb-16 text-center max-w-3xl mx-auto">
            ...
            <p className="text-slate-600 text-lg">
              Choose the duration that fits your needs. Each session is
              one-on-one and fully customized to your target score.
            </p>
          </div>

          <div className="grid gap-8 md:grid-cols-2">
            {ieltsWorkshop.workshops.map((w) => (
              <BaseCard
                key={w.id}
            ...
            <div className="space-y-12">
              <div>
                ...
                <div className="grid sm:grid-cols-1 gap-4">
                  {ieltsWorkshop.idealFor.map((item, i) => (
                    <div
                      key={i}
            ...
            <div className="bg-secondary p-12 rounded-[3rem] text-white shadow-2xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <h2 className="text-3xl font-black mb-6">
                  {ieltsWorkshop.commonFeatures.title}
                </h2>
                <p className="text-white/70 mb-8 text-lg font-medium">
                  {ieltsWorkshop.commonFeatures.description}
                </p>
                <ul className="space-y-6">
                  {ieltsWorkshop.commonFeatures.features.map((feature, i) => (
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-black text-slate-900 lg:text-5xl mb-6">
              Book Your <span className="text-primary">IELTS Workshop</span>
            </h2>
            <p className="text-slate-600 text-lg">
          ...
          <ExamWorkshopForm examType="IELTS" />
        </div>
      </section>
    </div>
  );
