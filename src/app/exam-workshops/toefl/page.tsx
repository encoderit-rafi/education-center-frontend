...
export const toeflWorkshop = {
  ...
  description:
    "Our intensive workshops at TEPTH – The Exam Preparation & Testing House help you quickly understand the exam format, master key strategies, and improve your performance in TOEFL iBT — all in focused sessions designed for busy candidates.",
  ...
  workshops: [
    ...
    },
    {
      ...
      currency: "AED",
      description:
        "Provides a more comprehensive review of three exam modules, suitable for strengthening multiple skills quickly.",
      includes: [
        "Exam structure and task types",
        "Practical strategies for each module",
    ...
    },
    {
      ...
      includes: [
        ...
        "Examiner expectations analysis",
        "Comprehensive task strategies",
...
export default function ExamWorkshopsTOEFL() {
  return (
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center gap-6 px-4">
                <div className="flex items-center gap-2 text-sm font-bold text-slate-500">
                  ...
                  {toeflWorkshop.logistics.location}
                </div>
                <div className="flex items-center gap-2 text-sm font-bold text-slate-500">
                  <Calendar className="size-4 text-primary" />
                  {toeflWorkshop.logistics.scheduling} Schedule
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-12">
              <div>
                ...
                <div className="grid sm:grid-cols-1 gap-4">
                  {toeflWorkshop.idealFor.map((item, i) => (
            ...
            <div className="bg-secondary p-12 rounded-[3rem] text-white shadow-2xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <h2 className="text-3xl font-black mb-6">
                  {toeflWorkshop.commonFeatures.title}
                </h2>
                <p className="text-white/70 mb-8 text-lg font-medium">
                  {toeflWorkshop.commonFeatures.description}
                </p>
                <ul className="space-y-6">
                  {toeflWorkshop.commonFeatures.features.map((feature, i) => (
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-black text-slate-900 lg:text-5xl mb-6">
              Book Your <span className="text-primary">TOEFL Workshop</span>
            </h2>
            <p className="text-slate-600 text-lg">
          ...
          <ExamWorkshopForm examType="toefl" />
        </div>
      </section>
    </div>
  );
