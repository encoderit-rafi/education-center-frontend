...
export default function PaymentFailedClient() {
  ...
  return (
    <div className="relative min-h-[85vh] w-full flex items-center justify-center bg-linear-to-br from-slate-50 via-gray-50 to-slate-100/70 py-16 px-4 md:px-6 overflow-hidden">
      ...
      <div className="absolute top-10 right-10 w-72 h-72 rounded-full bg-rose-200/20 blur-3xl animate-pulse duration-8000" />
      <div className="absolute bottom-10 left-10 w-96 h-96 rounded-full bg-maroon-100/10 blur-3xl animate-pulse duration-10000 delay-2000" />
      <div className="absolute top-1/2 right-2/3 -translate-x-1/2 -translate-y-1/2 w-80 h-80 rounded-full bg-amber-100/15 blur-3xl animate-pulse duration-9000 delay-1000" />
      ...
      <div className="relative w-full max-w-xl bg-white/80 backdrop-blur-md border border-white/60 shadow-[0_24px_60px_-15px_rgba(0,0,0,0.05)] rounded-3xl overflow-hidden transition-all duration-300 hover:shadow-[0_32px_70px_-10px_rgba(0,0,0,0.08)]">
        ...
        <div className="h-2 w-full bg-linear-to-r from-rose-400 via-red-500 to-maroon-700" />
        ...
        <div className="p-6 md:p-8 text-center flex flex-col items-center">
          ...
          <div className="relative flex items-center justify-center mb-6 mt-4">
            ...
            <div className="relative z-10 w-16 h-16 rounded-full bg-linear-to-tr from-rose-500 to-red-600 flex items-center justify-center text-white shadow-lg shadow-rose-500/30 transition-transform duration-300 hover:scale-105">
