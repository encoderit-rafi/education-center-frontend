  ...
  return (
    <main className="font-sans selection:bg-red-100 selection:text-red-900">
      ...
      <section className="py-32 px-8">
        <div className="max-w-7xl mx-auto rounded-[3rem] overflow-hidden relative min-h-[450px] flex items-center bg-[#991B1B]">
          ...
          <div className="relative z-10 w-full p-16 md:p-24 flex flex-col md:flex-row justify-between items-center gap-16">
            <div className="max-w-xl space-y-6 text-center md:text-left">
              ...
              <p className="text-white/80 text-lg md:text-xl leading-relaxed font-light py-4">
