            ...
            <div className="lg:col-span-8 space-y-20">
              ...
              <div>
                <div className="flex items-center gap-6 mb-12">
                  ...
                  <h2 className="text-3xl font-headline font-extrabold text-secondary tracking-tight">
                    Workshop Selection
                  </h2>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-3 md:col-span-2">
                    ...
                    <div className="relative group">
                      ...
                      <span className="material-symbols-outlined absolute right-6 top-1/2 -translate-y-1/2 text-secondary/40 pointer-events-none group-hover:text-primary transition-colors">
                        expand_more
                      </span>
                    </div>
                  </div>
            ...
            <div className="lg:col-span-4">
              <div className="sticky top-32 space-y-8">
                <div className="bg-secondary rounded-[3rem] p-10 text-white relative overflow-hidden shadow-2xl shadow-secondary/20 border border-white/5">
                  ...
                  <h3 className="text-2xl font-headline font-extrabold mb-10 tracking-tight">
                    Booking Summary
                  </h3>
                  ...
                  <div className="space-y-6 mb-12 relative z-10">
                    ...
                    <div className="flex justify-between items-end pt-4">
                      ...
                      <div className="flex items-baseline gap-1">
                        ...
                        <span className="text-5xl font-black text-primary font-headline animate-in zoom-in-50 duration-300">
                          {selectedWorkshop?.price}.00
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="p-8 bg-surface-container-low rounded-3xl border border-outline/5 flex items-center gap-6">
                  ...
                  <div>
                    <h5 className="text-sm font-extrabold text-secondary leading-tight">
                      Secure Checkout
                    </h5>
                    <p className="text-[10px] text-on-surface-variant/60 font-medium uppercase tracking-widest mt-1">
