...
export default function ExamPreparationTOEFL() {
  return (
              ...
              <div className="grid sm:grid-cols-2 gap-8 mb-10">
                <div>
                  ...
                  <ul className="space-y-3">
                    {toeflCourse.exam.usage.map((item, i) => (
                      <li
                        key={i}
        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
          <div className="mb-20 text-center max-w-3xl mx-auto space-y-4">
            <h2 className="text-4xl font-black text-slate-900 tracking-tight leading-tight">
              TOEFL <span className="text-primary">Preparation Path</span>
            </h2>
            <p className="text-slate-600 text-lg font-medium leading-relaxed">
              Master academic English with our specialized TOEFL iBT programs. Choose the format that fits your learning pace and target score.
            </p>
          </div>

          <div className="grid gap-8 lg:grid-cols-2">
            {toeflCourse.courses.map((course, index) => (
              <BaseCard
                key={course.id}
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-black text-slate-900 lg:text-5xl mb-6">
              Enroll in <span className="text-primary">TOEFL iBT Preparation</span>
            </h2>
          ...
          <ExamPreparationForm initialExam="TOEFL" />
        </div>
      </section>
