            ...
            <div className="flex-1 space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                ...
                <div className="group p-6 bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                  ...
                  <h4 className="text-xl font-bold text-secondary mb-3">Headquarters</h4>
                ...
                <div className="group p-6 bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                  ...
                  <h4 className="text-xl font-bold text-secondary mb-3">Working Hours</h4>
                  <div className="text-sm text-on-surface-variant leading-relaxed space-y-1">
                    <p className="text-sm text-primary font-semibold text-on-surface-variant leading-relaxed">Saturday to Thursday</p>
                    <p className="text-sm text-primary font-semibold text-on-surface-variant leading-relaxed">9:00 AM to 9:00 PM</p>
                  </div>
                </div>
              </div>
            </div>
