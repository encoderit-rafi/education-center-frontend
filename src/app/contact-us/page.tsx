...
export default function ContactUs() {
  ...
  return (
    <main className="bg-white min-h-screen">
      {/* Hero Section */}
      <section className="py-10 md:py-24 px-4 sm:px-8 max-w-screen-2xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-24 items-center">
          ...
          <div className="relative group overflow-hidden sm:overflow-visible">
            <div className="absolute inset-0 bg-primary/5 rounded-xl blur-3xl opacity-50 transition-opacity group-hover:opacity-100"></div>
      ...
      <section className="px-4 py-8 sm:px-8 sm:py-12 max-w-screen-2xl mx-auto overflow-hidden">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-20">
          {/* Left Side: Contact Details */}
          <div className="relative h-full flex flex-col justify-start gap-6 sm:gap-8">
            {/* Header */}
            ...
            <div className="relative z-10 space-y-4 animate-fade-up">
              <Link href="tel:+97165531250" className="block">
                <div className="group flex flex-row items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition-all duration-300 hover:-translate-y-0.5 hover:border-primary/50 hover:shadow-md">
                  ...
                  <div className="space-y-0.5">
                    <h3 className="text-base font-semibold text-slate-800 group-hover:text-primary transition-colors tracking-tight rtl:text-right" dir="ltr">
              ...
              <Link href="mailto:info@tepth.org" className="block">
                <div className="group flex flex-row items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white transition-all duration-300 hover:-translate-y-0.5 hover:border-primary/50 hover:shadow-md">
                  ...
                  <div className="space-y-0.5 min-w-0">
                    <h3 className="text-base font-semibold text-slate-800 group-hover:text-primary transition-colors tracking-tight truncate">
              ...
              {/* Office Hours Card */}
              <div className="bg-slate-50/50 border border-slate-200/60 h-fit rounded-xl flex flex-row gap-4 p-4 sm:p-5 transition-all duration-300">
