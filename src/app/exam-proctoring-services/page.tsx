      ...
      <section className="relative px-8 py-32 min-h-[600px] flex items-center bg-white">
        <div className="relative z-10 max-w-6xl mx-auto text-left w-full">
          ...
          <p className="text-lg text-slate-600 max-w-2xl leading-relaxed mb-12">
            Secure, accredited test administration — in-centre or remote —
            conducted by certified proctors who uphold the highest global
            standards of exam integrity.
          </p>
        </div>
      </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
                  ...
                  <div className="relative z-20 flex flex-col h-full justify-between">
                    <div>
                      ...
                      <p className="text-slate-500 text-lg leading-relaxed max-w-xl">
                        We specialize in managing secure sittings across
                        multiple geographic locations, utilizing biometric
                        verification and iron-clad surveillance standards.
                      </p>
                    </div>
                    <div className="mt-14 flex gap-3 flex-wrap">
                      ...
                      <span className="px-5 py-2 rounded-full bg-white text-slate-700 text-[10px] font-bold uppercase tracking-widest border border-slate-200 shadow-sm">
                        ISO Certified
                      </span>
                    </div>
                  </div>
                ...
                <div className="md:col-span-4 bg-slate-950 p-12 rounded-3xl text-white relative overflow-hidden group hover:-translate-y-1 transition-all duration-500 shadow-2xl">
                  <div className="relative z-10 h-full flex flex-col justify-between">
                    <div>
                      <span className="material-symbols-outlined text-4xl mb-8 text-red-500 group-hover:rotate-12 transition-transform duration-500">
                        analytics
                      </span>
                      ...
                      <p className="text-slate-400 leading-relaxed text-base">
                        Proprietary anomaly detection algorithms monitored by
                        human invigilators for 100% score validity.
                      </p>
                    </div>
                ...
                <div className="md:col-span-4 bg-white/50 backdrop-blur-xl p-12 rounded-3xl border border-slate-200/80 hover:bg-white/70 transition-all duration-500 shadow-md hover:shadow-xl relative group">
                  <span className="material-symbols-outlined text-red-800 text-3xl mb-8 block group-hover:scale-x-[-1] transition-transform duration-700">
                    history_edu
                  </span>
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    Translating massive testing datasets into actionable
                    intelligence for admissions and compliance boards.
                  </p>
                ...
                <div className="md:col-span-8 bg-slate-900 p-12 rounded-3xl text-white flex flex-col lg:flex-row gap-14 items-center relative overflow-hidden group">
                  <div className="flex-1 relative z-10">
                    ...
                    <p className="text-slate-400 leading-relaxed text-lg">
                      Our proctoring engine connects natively with Canvas,
                      Moodle, and Blackboard via LTI 1.3 Advantage standards.
                    </p>
                  </div>
                  <div className="grid grid-cols-2 gap-3 relative z-10">
                    {[
                      ...
                      <div
                        key={tech.label}
                        className="bg-white/5 border border-white/10 p-5 rounded-2xl flex flex-col items-center gap-2.5 backdrop-blur-sm hover:bg-white/10 transition-colors cursor-default group/tech"
                      >
                        <span className="material-symbols-outlined text-red-400 group-hover/tech:scale-110 transition-transform">
                          {tech.icon}
                        </span>
                        <span className="text-[9px] font-black uppercase tracking-widest text-slate-500 group-hover/tech:text-red-300 transition-colors">
                          {tech.label}
                        </span>
                      </div>
                    ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
                    ...
                    {[
                      {
                        ...
                        desc: "Create your digital profile and upload a verified government-issued ID document.",
                        icon: "id_card",
                      },
                      {
                        step: "02",
                        title: "Session Scheduling",
                        desc: "Browse our premium UAE venues or select an available remote proctoring window.",
                        icon: "calendar_month",
                      },
                      {
                        step: "03",
                        title: "Secure Booking",
                        desc: "Finalize your sitting through our encrypted, PCI-compliant payment portal.",
                        icon: "lock",
                      },
                      {
                        step: "04",
                        title: "Test Day",
                        desc: "Arrive at centre or log in remotely for a professionally proctored session.",
                        icon: "verified_user",
                      },
                    ].map((point) => (
                      <div key={point.step} className="flex gap-8 group">
                        <div className="relative z-10 w-[4.5rem] h-[4.5rem] rounded-2xl bg-slate-50 border border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover:bg-red-800 group-hover:border-red-800 transition-all duration-500 group-hover:shadow-[0_16px_40px_rgba(153,27,27,0.2)]">
                          <span className="material-symbols-outlined text-slate-400 text-2xl group-hover:text-white transition-colors duration-300">
                            {point.icon}
                          </span>
                          <span className="absolute -top-2.5 -right-2.5 px-2.5 py-0.5 rounded-full bg-slate-900 text-white text-[9px] font-black shadow-md group-hover:bg-red-600 transition-colors duration-300">
                            {point.step}
                          </span>
                        </div>
                        <div className="pt-2">
                          <h4 className="text-xl font-extrabold text-slate-900 font-headline mb-2 tracking-tight group-hover:text-red-800 transition-colors duration-300">
                            {point.title}
                          </h4>
                ...
                <div className="md:col-span-5 lg:col-span-4 grid grid-cols-1 gap-8">
                  ...
                  <div className="bg-red-800 p-10 rounded-3xl text-white relative overflow-hidden group shadow-xl">
                    <span className="material-symbols-outlined text-3xl mb-6 text-red-200 group-hover:rotate-[360deg] transition-transform duration-1000">
                      workspace_premium
                    </span>
                    <h4 className="text-2xl font-bold font-headline mb-3 tracking-tight">
                      Accredited Excellence
                    </h4>
                    <p className="text-red-100/70 text-sm leading-relaxed mb-6">
                      Authorised proctoring for IELTS, PTE Academic, OET, and
                      CELPIP.
                    </p>
                    <div className="flex items-center gap-3 border-t border-white/15 pt-5">
                      <span className="w-6 h-px bg-red-300" />
                      <span className="text-[9px] font-black uppercase tracking-[0.2em] text-red-200/80">
                        View Requirements
                      </span>
                    </div>
                  ...
                  <div className="bg-slate-50 p-10 rounded-3xl border border-slate-100 group hover:bg-white transition-all duration-500 shadow-sm hover:shadow-xl">
                    <div className="w-12 h-12 rounded-xl bg-slate-200/60 flex items-center justify-center mb-8 group-hover:bg-red-50 transition-colors duration-300">
                      <span className="material-symbols-outlined text-slate-500 group-hover:text-red-800 transition-colors duration-300">
                        support_agent
                      </span>
                    </div>
                    <h4 className="text-xl font-bold font-headline mb-3 text-slate-900 tracking-tight">
                      Human-Centric Support
                    </h4>
                    <p className="text-slate-500 text-sm leading-relaxed">
                      12/6 active candidate guidance for technical and booking
                      assistance.
                    </p>
                  </div>
                  ...
                  <div className="bg-slate-950 p-10 rounded-3xl text-white relative overflow-hidden group">
                    <span className="material-symbols-outlined text-3xl mb-6 text-red-400 relative z-10">
                      shield
                    </span>
                    <h4 className="text-xl font-bold font-headline mb-3 tracking-tight relative z-10">
                      Secure Environment
                    </h4>
                    <p className="text-slate-400 text-sm leading-relaxed relative z-10">
                      Multi-layered identity checks and 360° surveillance for
                      absolute exam integrity.
                    </p>
