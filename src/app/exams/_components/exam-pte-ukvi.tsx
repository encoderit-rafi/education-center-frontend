...
export default function ExamPTEUKVI() {
  return (
    <div className="min-h-screen">
      <BaseHeroSection image={"/images/exams/ielts/ielts-1.jpg"}>
        <div className="section-container space-y-6 base-px base-py">
          <h1 className="base-hero-section-heading">
            PTE UKVI<span className="italic text-primary">Exams</span>
          </h1>
          <p className="base-hero-section-description">
            UK Visas and Immigration (UKVI) approved Secure English Language
            Tests administered at TEPTH in Dubai Silicon Oasis. Select the test
      ...
      <div className="section-container base-px base-py">
        <h2 className="section-title text-center">
          Choose Your <span>PTE UKVI</span> Test
        </h2>
        <p className="mx-auto section-subtitle text-center">
          Each PTE UKVI variant is designed for a specific purpose. Select the
          one that matches your visa, academic, or professional goal.
        </p>
