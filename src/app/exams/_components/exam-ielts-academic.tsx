...
const ieltsAcademicData = {
  id: EXAM_IDS_DATA.ielts_academic.id,
  name: "IELTS Academic",
...
export default function ExamIELTSAcademic() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <BaseHeroSection image={ieltsAcademicData.image}>
        <div className="section-container space-y-6 base-px base-py">
          ...
          <p className="base-hero-section-description text-red-50 max-w-2xl">
            {ieltsAcademicData.content}
          </p>
          <Link
            href={`/book-exams/${ieltsAcademicData.id}`}
      ...
      <div className="relative z-10 -mt-12 section-container base-px">
        <div className="grid grid-cols-2 gap-4 lg:grid-cols-5">
          {ieltsAcademicData.stats?.map((stat, i) => (
            <BaseCard
              key={i}
          ...
          {ieltsAcademicData.resultTimeline && (
        ...
        <div className="lg:col-span-2 space-y-16">
          ...
          <section>
            ...
            <div className="prose prose-red max-w-none text-gray-600 leading-relaxed space-y-4">
              {ieltsAcademicData.overview.split("\n\n").map((para, i) => (
                <p key={i}>{para}</p>
              ))}
            </div>
          </section>
          ...
          <section>
            ...
            {ieltsAcademicData.testFormatIntro && (
            ...
            <div className="space-y-8">
              {ieltsAcademicData.sections.map((section, i) => (
                <div
                  key={i}
        ...
        <aside className="space-y-8">
          ...
          {ieltsAcademicData.acceptedFor && (
            <BaseCard className="p-8 border-primary/10 bg-primary/5">
              ...
              <ul className="space-y-4">
                {ieltsAcademicData.acceptedFor.map((item, i) => (
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-red-100">
                  Book your {ieltsAcademicData.name} test date today at TEPTH.
                </p>
              </div>
              <Link
                href={`/book-exams/${ieltsAcademicData.id}`}
